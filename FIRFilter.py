...
from numpy import sin, pi, absolute, arange, linspace
...
# Signal parameters
#------------------------------------------------
sample_rate = 500.0;  # sampling rate
ffs = [32]  # frequencies of the signal
...
for ff in ffs:
    ...
    plotSignal(squareWave, filtered_squarewave, squareInterval, 'Square wave', ff)
